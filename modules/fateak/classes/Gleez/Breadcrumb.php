...
class Gleez_Breadcrumb
{
	...
	{
                $breadcrumb_config = Kohana::$config->load('breadcrumb');
		$view = View::factory(static::$default)
					->set('items',         $this->items)
					->set('items_count',   count($this->items))
					->set('separator',     $breadcrumb_config->get('separator', '&nbsp;&gt;&nbsp;'))
					->set('last_linkable', $breadcrumb_config->get('last_linkable', false));
